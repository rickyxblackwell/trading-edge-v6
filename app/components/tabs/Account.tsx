      ...
      <section style={{ marginBottom: 24 }}>
        ...
        <div className="glass" style={{ borderRadius: 16, overflow: "hidden", marginTop: 12 }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <div style={{ marginLeft: 10 }}>
                ...
                <span
                  ...
                  style={{
                    fontSize: 11,
                    color: maskedAvKey ? "var(--text2)" : "var(--red)",
                    display: "block",
                    marginTop: 2,
                  }}
                >
                  {maskedAvKey ?? "Not connected"}
                </span>
              </div>
            </div>
            <span
              ...
              style={{
                fontSize: 10,
                color: maskedAvKey ? "var(--green)" : "var(--red)",
                background: maskedAvKey ? "rgba(52,211,153,0.1)" : "rgba(248,113,113,0.1)",
                border: maskedAvKey
                  ? "1px solid rgba(52,211,153,0.2)"
                  : "1px solid rgba(248,113,113,0.2)",
                borderRadius: 999,
            ...
            >
              {maskedAvKey ? "Connected" : "Not set"}
            </span>
          </div>

          {/* Update AV key toggle row */}
          <button
          ...
          >
            ...
            <ChevronRight
              ...
              style={{
                color: "var(--text3)",
                transform: avExpanded ? "rotate(90deg)" : "rotate(0deg)",
                transition: "transform 0.2s ease",
              }}
            />
          </button>

          {/* AV key expanded panel */}
          {avExpanded && (
            <div style={{ borderTop: "1px solid var(--border)", padding: 16 }}>
              <div style={{ position: "relative" }}>
                <input
                  ...
                  value={newAvKey}
                  onChange={(e) => setNewAvKey(e.target.value)}
                ...
                <button
                  ...
                  onMouseEnter={(e) => (e.currentTarget.style.color = "var(--text)")}
                  onMouseLeave={(e) => (e.currentTarget.style.color = "var(--text2)")}
                  aria-label={showAvKey ? "Hide key" : "Show key"}
                >
                  {showAvKey ? <EyeOff size={16} /> : <Eye size={16} />}
                </button>
              </div>
              ...
              {avSaveSuccess ? (
                ...
                <button
                  ...
                  disabled={!newAvKey.trim() || avSaving}
                  className="btn-accent"
                  style={{
                    width: "100%",
                    height: 44,
                    ...
                    borderRadius: 12,
                    border: "none",
                    cursor: newAvKey.trim() && !avSaving ? "pointer" : "not-allowed",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    gap: 8,
                    ...
                    fontWeight: 600,
                    color: "var(--bg)",
                    opacity: !newAvKey.trim() || avSaving ? 0.5 : 1,
                    fontFamily: "var(--font-inter, Inter, sans-serif)",
                  }}
                >
